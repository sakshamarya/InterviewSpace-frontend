...
export default function AboutUs(props) {
  ...
  async function getSessionRecords(id)
  {
    ...
    console.log(id);
    const res = await axios.post("https://interviewspace-backend.onrender.com/getSessionRecords");

    axios.post("https://interviewspace-backend.onrender.com/getSessionRecords",{id}).then((res)=>{
